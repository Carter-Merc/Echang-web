      ...
      <div style={container}>
        ...
        <div style={detailSection}>
          ...
          <div style={contentColumn}>
            ...
            <h2 style={serviceHeading}>Engineering & Material Supply</h2>
            <ul style={serviceList}>
              ...
              <li style={listItem}>
                <span style={bulletPoint}></span>
                Supply, Installation and Maintenance of LP & HP Pumps.
              </li>
              <li style={listItem}>
                <span style={bulletPoint}></span>
                Supply, Installation and Maintenance of Valves.
              </li>
              <li style={listItem}>
                <span style={bulletPoint}></span>
                Petroleum Products Supply & Distribution.
              </li>
              <li style={listItem}>
                <span style={bulletPoint}></span>
              ...
              <li style={listItem}>
                <span style={bulletPoint}></span>
                Compressors Supply and Maintenance.
              </li>
              <li style={listItem}>
                <span style={bulletPoint}></span>
                Skips Supply.
