...
export const ServicesDetailDotted: React.FC = () => {
      ...
      <div style={container}>
        ...
        <div style={detailSection}>
          ...
          <div style={contentColumn}>
            ...
            <h2 style={serviceHeading}>Technical Management & Consultancy</h2>
            <ul style={serviceList}>
              ...
              <li style={listItem}>
                <span style={bulletPoint}></span>
                Marine Survey & Audit: Warranty Survey, OVID, DP & FMEA Proving Trial.
              </li>
              <li style={listItem}>
                <span style={bulletPoint}></span>
                Inspection: Vessel, Jetty, & SBM Inspection.
              </li>
              <li style={listItem}>
                <span style={bulletPoint}></span>
              ...
              <li style={listItem}>
                <span style={bulletPoint}></span>
                Facility & Platform Upgrade, Rehabilitation and Repairs.
              </li>
              <li style={listItem}>
                <span style={bulletPoint}></span>
              ...
              <li style={listItem}>
                <span style={bulletPoint}></span>
                Manning and Personnel Services.
              </li>
              <li style={listItem}>
                <span style={bulletPoint}></span>
                Legal Services.
