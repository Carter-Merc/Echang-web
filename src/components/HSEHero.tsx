...
export const HSEHero: React.FC = () => {
  const { isMd } = useBreakpoint()
  const [currentSlide, setCurrentSlide] = useState(0)

  const slides: HSESlide[] = [
    {
      title: "Health Safety and management",
      subtext: "Policy, Management commitment & Sustainability.",
      buttonText: "Learn More"
    },
    {
      title: "Health Safety and management",
      subtext: "Learn about our health, safety, environment, Security and community affairs. (HSES & CA) Policy.",
      buttonText: "Learn More"
    }
  ]
      ...
      <div style={container}>
        <div style={slideContainer}>
          {slides.map((slide, index) => (
            ...
            >
              <div style={eyebrow}>Health Safety & Environment</div>
